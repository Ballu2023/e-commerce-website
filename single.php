...
<input type="submit" class="intro" name="search_btn" value="search">
   ...
   <button type="submit" class="btn"><a href="">Add To Cart : 0</a></button> 
...
-->
    ...
    <div class="assign_mode">
       <img src="cloth/360.jpg" width="500px" height="500px" id="imp">
    <div class="deeper">
        <div class="upper">
      <img src="cloth/360.jpg" width="100px" height="100px" class="imp">  
      <img src="image/img/A%20mighty%20wind.jpg" width="100px" height="100px" class="imp">  
      <img src="image/img/Black%20Adam.jpg" width="100px" height="100px" class="imp">  
      <img src="image/img/Black%20Panther%202.jpg" width="100px" height="100px" class="imp">  
        </div>
    ...
    <div class="assign_mode">
       ...
       <h1>product Totle</h1> 
        ...
        <h3>old price<del>0 </del>0</h3>
<button type="submit" class="btns"><a href="">Add to cart</a></button>
        </div>
    </div>
        </div>
        -->
...
<script>
        var productimages = document.getElementById("imp");
        var smallimages = document.getElementsByClassName("imp")
        
        smallimages[0].onclick = function(){
        productimages.src =  smallimages[0].src;
        }
        smallimages[1].onclick = function(){
        productimages.src =  smallimages[1].src;
        }
        smallimages[2].onclick = function(){
        productimages.src =  smallimages[2].src;
        }
        smallimages[3].onclick = function(){
        productimages.src =  smallimages[3].src;
        }
        </script>
